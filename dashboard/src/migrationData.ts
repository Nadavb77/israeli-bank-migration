...
export const migrationItems: MigrationItem[] = [
  ...
  { id: 'sc-masav-14', layer: 'Scripts', file: 'scripts/masav_generator.py', line: 230, description: 'Header bank_code \'00\' → \'000\'', category: 'Hardcoded Value', status: 'pending' },
  { id: 'sc-masav-15', layer: 'Scripts', file: 'scripts/masav_generator.py', line: 249, description: 'Trailer bank_code \'99\' → \'099\'', category: 'Hardcoded Value', status: 'pending' },
